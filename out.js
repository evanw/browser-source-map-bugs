(() => {
  ...
  var require_react_dom_production_min = __commonJS((exports) => {
    ...
    var ve = {eventTypes: oe, extractEvents: function(a, b, c, d) {
      ...
      f ? (me && "ko" !== c.locale && (se || f !== oe.compositionStart ? f === oe.compositionEnd && se && (e = ae()) : (Yd = d, Zd = "value" in Yd ? Yd.value : Yd.textContent, se = true)), f = ge.getPooled(f, b, c, d), e ? f.data = e : (e = re(c), null !== e && (f.data = e)), Xd(f), e = f) : e = null;
            ...
            if (null !== h && "object" === typeof h && "function" === typeof h.then) {
              ...
              do {
                ...
                if (x = 13 === p.tag) {
                  ...
                  if (null !== z)
                    x = null !== z.dehydrated ? true : false;
                  else {
    ...
    Rj = function(a, b, c) {
      ...
      switch (b.tag) {
        ...
        case 17:
          return d = b.type, e = b.pendingProps, e = b.elementType === d ? e : ig(d, e), null !== a && (a.alternate = null, b.alternate = null, b.effectTag |= 2), b.tag = 1, L(d) ? (a = true, Gf(b)) : a = false, qg(b, c), Lg(b, d, e), Ng(b, d, e, c), gi(null, b, d, true, a, c);
        case 19:
          return mi(a, b, c);
      }
      throw Error(u(156, b.tag));
  ...
  log(str);
  react_dom.render(react.default.createElement("div"), document.body);
})();
